...
<form action="active.php" method="post"  >
            	<p ><?php if ($leaddetails[0]['active'] == 0) 
						echo '<button type="submit" class="btn btn-primary" name="activate">Activate Franchisee</button>';
						else
						echo '<button type="submit" class="btn btn-primary" name="activate">Deactivate Franchisee</button>';
                    ...
                    <?php echo resultBlock($errors,$successes); ?>
						<table class="table table-striped table-bordered " id="fran_detail_table">
                         ...
                         <tr>
                          ...
                          <tr>
                            <td>Birth Date </td>
                            <td><?php echo $leaddetails[0]['dob']; ?></td>
                            <td>Marital Status </td>
                            <td><?php echo $leaddetails[0]['marital_status']; ?></td>
                          </tr>
                          <tr>
                            <td colspan="4">&nbsp;</td>
                          </tr>
                          ...
                          <tr>
                            <td>Birth Date </td>
                            <td><?php echo $leaddetails[0]['adob']; ?></td>
                            <td>Marital Status </td>
                            <td><?php echo $leaddetails[0]['amarital_status']; ?></td>
                          </tr>
                          <tr>
                            <td colspan="4">&nbsp;</td>
                          </tr>
                          ...
                          <tr>
                           ...
                           <tr>
                            ...
                            <td>EFIN</td>
                            <td><?php echo $leaddetails[0]['efin']; ?></td>
                          </tr>
                          <tr>
                            <td>Active Date </td>
                            <td><?php echo $leaddetails[0]['active_date']; ?></td>
                            <td>Developer</td>
                            <td><?php echo $leaddetails[0]['developer']; ?></td>
                          </tr>
                             <tr>
                           ...
                           <tr>
                             <td>Location Address </td>
                             <td><?php echo $leaddetails[0]['laddress2']; ?></td>
                             <td>Store Category </td>
                             <td><?php echo $leaddetails[0]['lstore2']; ?></td>
                           </tr>
                           <tr>
                             <td>Store Type </td>
                             <td><?php echo $leaddetails[0]['lstore_type2']; ?></td>
                             <td>City/State/Zip </td>
                             <td><?php echo $leaddetails[0]['lcity_state_zip2']; ?></td>
                           </tr>
                           <tr>
                             <td>Email</td>
                             <td><?php echo $leaddetails[0]['lemail2']; ?></td>
                             <td>Website</td>
                             <td><?php echo $leaddetails[0]['lwebsite2']; ?></td>
                           </tr>
                           <tr>
                             <td>Primary Phone </td>
                             <td><?php echo $leaddetails[0]['lphonee2']; ?></td>
                             <td>Secondary Phone</td>
                             <td><?php echo $leaddetails[0]['lphone22']; ?></td>
                           </tr>
                           <tr>
                             <td>Fax</td>
                             <td><?php echo $leaddetails[0]['lfax2']; ?></td>
                             <td>EFIN</td>
                             <td><?php echo $leaddetails[0]['efin2']; ?></td>
                           </tr>
                           <tr>
                             <td>Active Date </td>
                             <td><?php echo $leaddetails[0]['active_date2']; ?></td>
                             <td>Developer</td>
                             <td><?php echo $leaddetails[0]['developer2']; ?></td>
                           </tr>
                           <tr>
                           ...
                           <tr>
                             <td>Location Address </td>
                             <td><?php echo $leaddetails[0]['laddress3']; ?></td>
                             <td>Store Category </td>
                             <td><?php echo $leaddetails[0]['lstore3']; ?></td>
                           </tr>
                           <tr>
                             <td>Store Type </td>
                             <td><?php echo $leaddetails[0]['lstore_type3']; ?></td>
                             <td>City/State/Zip </td>
                             <td><?php echo $leaddetails[0]['lcity_state_zip3']; ?></td>
                           </tr>
                           <tr>
                             <td>Email</td>
                             <td><?php echo $leaddetails[0]['lemail3']; ?></td>
                             <td>Website</td>
                             <td><?php echo $leaddetails[0]['lwebsite3']; ?></td>
                           </tr>
                           <tr>
                             <td>Primary Phone </td>
                             <td><?php echo $leaddetails[0]['lphonee3']; ?></td>
                             <td>Secondary Phone</td>
                             <td><?php echo $leaddetails[0]['lphone23']; ?></td>
                           </tr>
                           <tr>
                             <td>Fax</td>
                             <td><?php echo $leaddetails[0]['lfax3']; ?></td>
                             <td>EFIN</td>
                             <td><?php echo $leaddetails[0]['efin3']; ?></td>
                           </tr>
                           <tr>
                             <td>Active Date </td>
                             <td><?php echo $leaddetails[0]['active_date3']; ?></td>
                             <td>Developer</td>
                             <td><?php echo $leaddetails[0]['developer3']; ?></td>
                           </tr>
                           <tr>
                             <td colspan="4">&nbsp;</td>
                           </tr>
                           ...
                           <tr>
                             ...
                             <td><?php echo $leaddetails[0]['last_bank']; ?></td>
                             <td>Company EIN or SSN</td>
                             <td><?php echo $leaddetails[0]['ssefin']; ?></td>
                           </tr>
                           <tr>
                             <td>Business name EIN registered under, or SSN name</td>
                             <td><?php echo $leaddetails[0]['ssn_name']; ?></td>
                             <td>Which bank will you use this tax season?</td>
                             <td><?php echo $leaddetails[0]['current_bank']; ?></td>
                           </tr>
                           <tr>
                             <td>Estimated Number of bank products - 2013</td>
                             <td><?php echo $leaddetails[0]['bank_product']; ?></td>
                             <td>In what type of account will your fees be deposited?</td>
                             <td><?php echo $leaddetails[0]['account_type']; ?></td>
                           </tr>
                           <tr>
                             <td>Routing Number</td>
                             <td><?php echo $leaddetails[0]['routing_number']; ?></td>
                             <td>Confirm Routing Number</td>
                             <td><?php echo $leaddetails[0]['routing_number_confirm']; ?></td>
                           </tr>
                           <tr>
                             <td>Account Number</td>
                             <td><?php echo $leaddetails[0]['account_no']; ?></td>
                             <td>Confirm Account Number</td>
                             <td><?php echo $leaddetails[0]['account_no_confirm']; ?></td>
                           </tr>
                          <tr>
                            <td colspan="4">&nbsp;</td>
                          </tr>
                          ...
                          <?php if ($comment) {foreach ($comments as $comment) {?>
                          <tr>
                            <td colspan="4"><?php 
