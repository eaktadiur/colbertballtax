...
$lang = array_merge($lang,array(
	...
	"ACCOUNT_REGISTRATION_COMPLETE_TYPE1"	=> "New User has been successfully registered.",
...
//webform
$lang = array_merge($lang,array(
	"WEBFORM_SPECIFY_FIRST_NAME"			=> "Please enter your First Name",
	"WEBFORM_SPECIFY_LAST_NAME"				=> "Please enter your Last Name",
	"WEBFORM_SPECIFY_ADDRESS"				=> "Please enter your Mailing Addresse",
	"WEBFORM_SPECIFY_CITY_STATE_ZIP"		=> "Please enter your City/State/Zip",
	"WEBFORM_SPECIFY_PHONE"					=> "Please enter your Phone",
	"WEBFORM_SPECIFY_EMAIL"					=> "Please enter your E-mail Address",
	"WEBFORM_SPECIFY_EVENT_DATE"			=> "Please Select Event Date",
	"WEBFORM_SUCCESS"						=> "Thank you for Registering for the 2013 Tax Year, you may now log-in using the email address you've provided.<br />Please remember to update your account when there are any changes throughout the year. <br> <br> Have a great Tax Year!",
	
	));
	
//franchise
$lang = array_merge($lang,array(
	"FRANCHISE_EFIN_IN_USE"			=> "Social Security %m1% already in use.",
	"FIlE_TYPE_NOT_SUPORTED"		=> "You can only upload jpg, jpeg, gif, png, doc, docx, txt, rtf, pdf, xls, xlsx, ppt, pptx files.",
	"FILE_UPLOAD_FAIL"				=> "Error in File Uploading",
	"FRANCHISE_ACTIVATION_MESSAGE"		=> "Please follow the link below to Login in your account. \n\n	%m1% \n\n	Username is your Email and password is your Social Security (EFIN).",
	));
