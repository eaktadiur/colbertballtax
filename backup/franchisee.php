	...
	if (in_array($extension, $allowedExts))
	  ...
	  if ($_FILES["files"]["error"] > 0)
		...
		if(!$franchise->status)
		{
			...
			if($franchise->ssefin_taken)	  $errors[] = lang("FRANCHISE_EFIN_IN_USE",array($ssefin));
			if($franchise->email_taken) 	  $errors[] = lang("ACCOUNT_EMAIL_IN_USE",array($email));	
			if($franchise->file_upload_fail)  $errors[] = lang("FILE_UPLOAD_FAIL");		
		}
		else
		{
			...
			if(!$franchise->AddFranchise())
			{
				...
				if($franchise->sql_failure)  $errors[] = lang("SQL_ERROR");
			}
		}
	}
	if(count($errors) == 0) {
					...
					<div class="box-content">
							...
							<fieldset>
                              ...
                              <div class="control-group">
                               ...
                               <div class="control-group">
								<label class="control-label" for="lphone2">Secondary Phone </label>
								<div class="controls">
