...
if (!empty($_POST)) {
    ...
    if (count($errors) == 0) {
        ...
        // . ' fax ' . $fax . ' email ' . $email; 
        // print '</p>';
        //echo $afname . ' alname ' . $alname . ' aemail ' . $aemail . ' relation ' . $arelation . ' aphone ' . $aphone . ' event date ' . $event_date
        ...
        <body>
            ...
            <div class="row-fluid">
                ...
                <div id="content" class="span8">
                    <p><img src="images/cb.jpg" alt="2013 Franchisee Events Form" /></p>
                        ...
                        <div class="box span12">
                            <?php if (count($successes) == 0) { ?>
                                <form class="form-horizontal" action="<?php $_SERVER['PHP_SELF'] ?>" method="post">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <select name="event_type" id="event_type">
                                                    ...
                                                    <option value="TAX SLAYER COMPUTER TRAINING">TAX SLAYER COMPUTER TRAINING</option>
                                                    <option value="SATELLITE TRAINING">SATELLITE TRAINING</option>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="box-header well" data-original-title>
                                        <h2><i class="icon-edit"></i> Training Confirmation</h2>
                                    </div>
                                    <div class="box-content">

                                        <fieldset>
                                            <!--  <div class="control-group">
                                                    <label class="control-label" for="alname">Dec 7- 9, 2013</label>
                                                    <div class="controls">
