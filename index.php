			...
			//See if the user's account is activated
				...
				{*/
					...
					//Redirect to user account page
						header("Location: dashboard.php?id=".$loggedInUser->user_id);
						die();
				//}
			}
				...
				<div class="well span5 center login-box">
					...
					<form class="form-horizontal" action="<?php $_SERVER['PHP_SELF'] ?>" method="post">
						<fieldset>
							...
							<div class="input-prepend" title="SSN#" data-rel="tooltip">
								<span class="add-on"><i class="icon-user"></i></span><input class="input-large span10" name="effin" id="effin" type="password" value="" />
				      </div>
